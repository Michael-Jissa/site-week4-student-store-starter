...
https://www.loom.com/share/276bac85f16140a9ba537748f9e6a06c

### Reflection

* Did the topics discussed in your labs prepare you to complete the assignment? Be specific, which features in your weekly assignment did you feel unprepared to complete?

The labs helped with Express routes, Prisma models, and CRUD flow. I felt least prepared for connecting front and backend.

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
I would improve error messages, polish UI consistency further, and implement more streach feautures like the filter. I’d also add safer status handling (enum) and better empty/error states in the frontend.

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

What went well was end-to-end flow (products -> cart -> order) and transactional order creation. What didn’t go as planned was deployment setup and port confusion.
